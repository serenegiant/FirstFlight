...
public class AutoPilotFragment extends BaseAutoPilotFragment {
	...
	public static AutoPilotFragment newInstance(final ARDiscoveryDeviceService device, final DeviceInfo info, final String pref_name, final int mode) {
...
//			curvature = mTraceCurvature;
		...
		protected PilotVector onCalc(final LineRec rec) {
			...
			// 解析データ
			msg1 = String.format(Locale.US, "%d,v(%3.0f,%3.0f,%5.1f,%5.2f),θ=%5.2f)",
			...
			case 1:	// TYPE_CIRCLE
			{
				...
				msg2 = String.format(Locale.US, "e(%5.2f,%5.2f,%5.2f),θ=%5.2f,s=%5.2f",
